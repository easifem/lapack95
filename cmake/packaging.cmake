...
IF(APPLE)
SET(CPACK_PACKAGING_INSTALL_PREFIX "/easifem/extpkgs/")
ELSE()
SET(CPACK_PACKAGING_INSTALL_PREFIX "/opt/easifem/extpkgs/")
ENDIF()
...
SET(CPACK_DMG_BACKGROUND_IMAGE "${CMAKE_CURRENT_SOURCE_DIR}/background.svg")
